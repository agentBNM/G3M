...
if __name__=="__main__":
    ...
    df = pd.read_csv("./results/result200000_0.csv")
    ...
    dfSummary["RelErr"] = (dfSummary["Phi"]-dfSummary["IL"])/dfSummary["IL"]
    dfSummary["RelErr"] = dfSummary["RelErr"].astype('float').round(2)
